                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                            <div class="login-btn-inner pull-right">
                                <div class="login-horizental">
                                    <button class="btn btn-sm btn-primary login-submit-cs" href="#" data-toggle="modal"
                                        data-target="#zoomInDown1" type="button" id="new">Nouveau Semestre</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                        <div class="chosen-select-single mg-b-20">
                                                            ...
                                                            <select data-placeholder="Choisir un type"
                                                                class="chosen-select" tabindex="-1" name="anne"
                                                                id="anne" required>
                                                    ...
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                        <div class="login-horizental">
                                                            <button class="btn btn-sm btn-primary login-submit-cs"
                                                                type="submit" id="SemBtn">Ajouter</button>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
                                                        <div class="login-horizental">
                            ...
                            <div class="analytics-content">
                                ...
                                <h2>
                                    <div class="row">
                                        ...
                                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                                            <button
                                                class="btn btn-success  widget-btn-1 btn-sm pull-left">Archiver</button>
                                        </div>
                                    </div>
                                </h2>
