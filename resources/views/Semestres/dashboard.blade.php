        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                    <div class="analytics-content">
                        <a href="">
                            <h5>Etudiants Exclus</h5>
                        </a>
                        <h2><span class="counter">{{$exclus}}</span> <span class="tuition-fees">semestre actuel</span>
                        </h2>
                ...
                <div class="white-box analytics-info-cs mg-b-10 res-mg-b-30 tb-sm-res-d-n dk-res-t-d-n">
                    ...
                    <ul class="list-inline two-part-sp">
                        ...
                        <li class="text-right graph-two-ctn"><i class="fa fa-level-up" aria-hidden="true"></i> <span
                                class="counter text-purple">{{$ens}}</span></li>
                    </ul>
                </div>
                <div
                    ...
                    <ul class="list-inline two-part-sp">
                        ...
                        <li class="text-right sp-cn-r"><i class="fa fa-level-up" aria-hidden="true"></i> <span
                                class="counter text-success">{{$nouveaux}}</span></li>
                    </ul>
                </div>
                <div class="white-box analytics-info-cs mg-b-10 res-mg-b-30 tb-sm-res-d-n dk-res-t-d-n">
                    ...
                    <ul class="list-inline two-part-sp">
                        ...
                        <li class="text-right graph-three-ctn"><i class="fa fa-level-up" aria-hidden="true"></i> <span
                                class="counter text-info">{{$endettes}}</span></li>
                    </ul>
                </div>
                <div class="white-box analytics-info-cs table-dis-n-pro tb-sm-res-d-n dk-res-t-d-n">
                    ...
                    <ul class="list-inline two-part-sp">
                        ...
                        <li class="text-right graph-four-ctn"><i class="fa fa-level-down" aria-hidden="true"></i> <span
                                class="text-danger"><span class="counter">{{$rep}}</span></span>
                        </li>
                    </ul>
                </div>
            </div>
