    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '.edit', function () {
            ...
            $.get("{{ url('edit_Student') }}" + '/' + product_id, function (data) {
                ...
                $('.modal-basic-inner p').html(
                    "Vous pouvez modifier les informations concernant chaque étudiant");
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        <div class="basic-login-inner modal-basic-inner">
                                                            ...
                                                            <form action="{{url('NouveauEtudiant')}}" method="post"
                                                                id="formEtud">
                                                                {!! csrf_field() !!}
                                                                <input type="hidden" name="id_stud" id="id_stud"
                                                                    value="{{0}}">
                                                                ...
                                                                <div class="form-group-inner">
                                                                    <div class="row">
                                                                        ...
                                                                        <div
                                                                            class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                                                                            <input type="text" class="form-control"
                                                                                placeholder="matricule" name="matricule"
                                                                                id="matricule" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="chosen-select-single">
                                                                                ...
                                                                                <select data-placeholder="Module..."
                                                                                    class="chosen-select"
                                                                                    multiple="multiple" name="modules[]"
                                                                                    id="module1">

                                                                                    @foreach($modules as $mod)
                                                                                    <option value="{{$mod->idMod}}">
                                                                                        {{$mod->nom}}</option>
                                                                                    @endforeach
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <div class="login-horizental">
                                                                                <button
                                                                                    ...
                                                                                    type="button"
                                                                                    id="newStud">Ajouter</button>
                                                                                <button
                                                                                    class="btn btn-sm btn-primary login-submit-cs"
                                                                                    type="button" id="updStud"
