     ...
     <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
        <div class="form-select-list"> <select class="form-control custom-select-value" name="account" placeholder="password" style="width: 80%;">
         ...
         <button class="btn btn-sm btn-primary login-submit-cs" type="submit">Ajouter</button>
            ...
            <h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapse1"> Groupe A1  </a>
                                     <a class="zoomInDown mg-t" href="#" data-toggle="modal" data-target="#edit"><i class="fa fa-edit pull-right"> </i> </a>
                                     <a href=""> <i class="fa fa-eye pull-right"> </i></a>
                                        </h4>
                                    </div>
