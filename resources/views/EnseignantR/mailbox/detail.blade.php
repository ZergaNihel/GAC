                ...
                <div class="hpanel email-compose mailbox-view">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="hpanel vw-mb">
                                        ...
                                        <div class="panel-footer ft-pn">
                                            ...
                                            <a href="/uploads/attachements/{{$m->att}}" download="{{$m->att}}"> <i
                                                    class="fa fa-download pull-right"></i></a>
                                        </div>
                                    </div>
                                    <br>
                                </div>
                    ...
                    <div class="panel-footer text-right ft-pn">
                        <div class="btn-group active-hook">
                            <a class="btn btn-default" href="{{ url()->previous() }}"><i class="fa fa-arrow-right"></i>
                                Précédent</a>
                            <button class="btn btn-default" onclick="window.print();"><i class="fa fa-print"></i>
                                Imprimer</button>
                            @if($message->delete == 0 )
                            <a class="btn btn-default" href="{{url('/delete_msg/'.$message->id.'/'.$id_notif)}}"><i
