                                ...
                                <tbody>
                                    ...
                                    <tr class="active unread">
                                        ...
                                        <td><a
                                                ...
                                                @if( App\User::find($notification->data['id_emt'])->role == 1 or
                                                App\User::find($notification->data['id_emt'])->role == 2 )
                                    ...
                                    <tr class="unread">
                                        ...
                                        <td><a
                                                href="{{url('/emails/view/'.$notification->data['id_msg'].'/'.$notification->id)}}">{{ App\User::find($notification->data['id_emt'])->name}}</a>
                                        </td>
                                        <td><a
                                                href="{{url('/emails/view/'.$notification->data['id_msg'].'/'.$notification->id)}}">
                                                {{$notification->data['sujet']}}
                                        ...
                                        <td class="text-right mail-date">
                                            {{\Carbon\Carbon::parse($notification->created_at)->toFormattedDateString()}}
                                        </td>
                                    </tr>
